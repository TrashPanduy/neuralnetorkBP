...
def initializeLayers(hidden_layer_amt,hidden_nodes_per_layer,output_nodes_amt,input_nodes_amt,weights_lower_bound,weights_upper_bound):
    neural_network = [[]]
...
def checkAcuracy(nerual_network,validation_data):
    index = 0
    count = 0 
...
def trainNetwork(hidden_layer_amt,iterations,hidden_nodes_per_layer,weights_lower_bound,learn_rate,weights_upper_bound,input_nodes_amt,output_nodes_amt):
    ...
    print(hidden_layer_amt)
    print(hidden_layer_amt)
    nerual_network = initializeLayers(hidden_layer_amt,hidden_nodes_per_layer,output_nodes_amt,input_nodes_amt,weights_lower_bound,weights_upper_bound)
    ...
    score = checkAcuracy(nerual_network,validation_data)
